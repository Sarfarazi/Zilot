...
public static class HttpClientExtensions
{
    ...
    public static async Task<TResponse?> PostAsync<TRequest, TResponse>(this HttpClient client, string url, TRequest data, CancellationToken cancellationToken  = default)
    {
    ...
    public static async Task<TResponse?> PutAsync<TRequest, TResponse>(this HttpClient client, string url, TRequest data, CancellationToken cancellationToken = default)
    {
        var content = new StringContent(JsonSerializer.Serialize(data, _jsonOptions), Encoding.UTF8, "application/json");
    ...
    public static async Task<bool> DeleteAsync(this HttpClient client, string url, CancellationToken cancellationToken = default)
    {
